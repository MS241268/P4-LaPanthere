...
function setUpLightBox() {
    window.targetLightbox, $(document).on("click", "[data-lightbox]", function(t) {
        ...
        var e = targetLightbox.attr("data-lightbox"),
            ...
            a = '<p class="lightbox-caption fs-6">' + targetLightbox.attr("data-caption") + "</p>",/*ajout de "fs-6" par MS*/
            o = "no-gallery-set",
        ...
        var n = "";
        1 == i && (n = "autoplay");
        var s = $('<div id="lightbox-modal" class="modal fade"><div class="modal-dialog"><div class="modal-content ' + l + ' blocs-lb-container"><button id="blocs-lightbox-close-btn" type="button" class="close-lightbox" data-bs-dismiss="modal" aria-label="fermeture du pop-up"><span aria-hidden="true">&times;</span></button><div class="modal-body"><a href="#" class="prev-lightbox text-bg-dark p-1" aria-label="image précédente"><i class="fa fa-chevron-left text-bg-dark p-3"></i></a><a href="#" class="next-lightbox text-bg-dark p-1" aria-label="image suivante"><i class="fa fa-chevron-right text-bg-dark p-3"></i></a><img id="lightbox-image"  src="' + e + '"><div id="lightbox-video-container" class="embed-responsive embed-responsive-16by9"><video controls ' + n + ' class="embed-responsive-item"><source id="lightbox-video" src="' + e + '" type="video/mp4"></video></div>' + a + "</div></div></div></div>");
